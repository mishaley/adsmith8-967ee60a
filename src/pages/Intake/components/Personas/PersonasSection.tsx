...
const PersonasSection: React.FC<PersonasSectionProps> = ({
  ...
  return <>
      <tr className="border-b">
        <td colSpan={2} className="py-4 text-lg">
          <div className="w-full text-left pl-4 flex items-center">
            ...
            {setPersonaCount && <div className="ml-4 w-20">
            ...
            <Button onClick={generatePersonas} disabled={isGeneratingPersonas || isGeneratingPortraits} className="ml-4" size="sm">
              {isGeneratingPersonas ? <>
      ...
      {isGeneratingPersonas && !hasPersonas ? <tr>
