...
const MapDisplay: React.FC<MapDisplayProps> = ({
  ...
  if (loading) {
    return <div className="h-[700px] flex items-center justify-center bg-gray-100 rounded">
  ...
  if (error) {
    return <div className="h-[700px] flex flex-col items-center justify-center bg-gray-100 rounded text-red-500 p-4">
  ...
  return <div className="w-full">
      <div className="h-[700px] overflow-hidden relative rounded">
