            ...
            <div className="mt-8">
              <table className="w-full border-collapse">
                <tbody>
                  ...
                  <FormField label="Name one of your offerings" helperText="We can add more later" value={offering} onChange={e => setOffering(e.target.value)} />
                  ...
                  <RecordingField label="Problems Solved" helperText="How does this offering help your customers?" value={problemsSolved} onChange={setProblemsSolved} placeholder="Speak for at least 30 seconds" />
                  <RecordingField label="Unique Offering" helperText="How is this offering better than alternatives?" value={uniqueOffering} onChange={setUniqueOffering} placeholder="Speak for at least 30 seconds" />
                  <tr className="border-b">
                    ...
                    <td className="py-4">
                      <StateSelectionMap value={geoBoundaries} onChange={setGeoBoundaries} />
                    </td>
                  </tr>
                  <tr className="border-b">
