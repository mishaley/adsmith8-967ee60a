  ...
  return <div className="flex flex-col h-full">
      ...
      <div className="flex-1">
        <div className="bg-[#d3e4fd] p-4 mb-2">
          <Button onClick={handleAdd} className="h-10 w-[100px] rounded-full bg-[#ecb652] text-[16px] text-[#154851] border-2 border-white hover:bg-[#ecb652]/90 font-bold">
            ADD
          </Button>
        </div>
        <div className="bg-white">
          {data.map(row => <div key={row.id} className="p-4 border-b whitespace-nowrap text-center">
